...
function changeCar(index){
    ...
    if(index==1){
        $('.car-img img').attr('src','/data/tms/website/html/images/carModel/x90p/black.png')
    ...
    if(index == 2){
        $('.car-img img').attr('src','/data/tms/website/html/images/carModel/x90p/blue.png')
    ...
    if(index == 3){
        $('.car-img img').attr('src','/data/tms/website/html/images/carModel/x90p/grey.png')
    ...
    if(index == 4){
        $('.car-img img').attr('src','/data/tms/website/html/images/carModel/x90p/white.png')
...
var player = new Aliplayer(
    {
        ...
        width: "100%",
        height: "100%",
        source: '/data/tms/website/html/videos/about/video/x90plus.mp4', //播放地址，可以是第三方直播地址，或阿里云直播服务中的拉流地址。
